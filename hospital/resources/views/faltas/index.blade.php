...
<a href="{{ url('faltas/create')}}" class="btn btn-warning">Agregar Falta</a>
...
<center><h2>REGISTRO DE FALTAS DEL PERSONAL</h2></center>
<br>
 ...
 <form action=" {{url('/faltas/index')}}" class="form-inline">
          <tr>
         <td class="a" width="35%">
